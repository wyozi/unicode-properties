/* decaffeinate suggestions: DS101: Remove unnecessary use of Array.from DS102: Remove unnecessary code created because of implicit returns DS207: Consider shorter variations of null checks Full docs: https://github.com/decaffeinate/decaffeinate/blob/master/docs/suggestions.md */
let eaw;
...
fs.writeFileSync('dist/trie.json', JSON.stringify(trie.toBuffer()));
fs.writeFileSync('dist/data.json', JSON.stringify({categories: Object.keys(categories), combiningClasses: Object.keys(combiningClasses), scripts: Object.keys(scripts), eaw: Object.keys(eaws)}));
